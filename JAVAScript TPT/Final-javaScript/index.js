...
// let new_arr = array1.map((curEle,index)=>{
//     return `Index no is ${index+1} and element is ${curEle}`
// })
// console.log(array1);
// console.log(new_arr);
...
// 2: multiplyeach element by 2 and return only 
// those elements which are greater then 10

// sol1: 
// let arr = [22,36,49,64,81];

// let arr_squre  = arr.map((ele,index,array)=>Math.sqrt(ele))
// console.log(arr_squre);


// sol2: 
// let arr = [2,3,4,6,8];
// let newArr = arr.map((ele)=>ele*2).filter((ele)=>ele>10).reduce((accumulator,curEle,index,arr)=>{
...
// 👉 Reduce method 
// flatten an array means to convert the 2d and 3d array into a 
...
// The reducer function four arguments:
...
// let sum = arr1.reduce((accumulator,curEle)=>{
//     return accumulator*=curEle;
// })
// console.log(sum)
...
//     ['zone_3','zone_4'],
//     ['zone_5','zone_6'],
//     ['zone_7',['zone_8','zone_3','zone_4']]
// ];

// let flatArr = arr.reduce((accum,curEle)=>{
...
// starting.prototype.indexOf(searchvalue ,[fromIndex])

// he indexOf() method returns the index of the (the posistion of)
// the first  occurrence of a specified text in a string


// const mytBioData = 'I am the Thapa Technical';
// console.log(mytBioData.indexOf("Thapa"))
// console.log(mytBioData.indexOf("T",10))

// console.log(mytBioData.lastIndexOf("a",10))
// console.log(mytBioData.search("Thapa"))

// 👉 Extracting string parts

// ther are 3 method for extracting a part of a string:
...
// slice() method
// extract part of string and return into new string


// var  start = "Apple , Banana , Kiwi";
// let res = start.slice(0,5);
// console.log(res)
 



// let twitterText = "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Similique inventore excepturi odit nesciunt nisi incidunt molestiae dolore debitis, placeat aliquid minus, vitae voluptatem, perspiciatis mollitia sed recusandae dolorem id maiores. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Unde magnam, in repudiandae quo ducimus ad nisi consequatur totam cumque, numquam quas quia. Et veritatis corporis tempora in dolor! Nam, q necessitatibus doloremque quo tempora minus eius. Porro, animi vitae deleniti quo quis provident magni sint? "

// let  myActualTweet=twitterText.slice(0,280)
...
// The diffrence is that the second parameter specifiers the 
